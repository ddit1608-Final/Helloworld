...
<article>
<div>
		<a href="<%=request.getContextPath()%>/qna/qnaBoardList.do"><img id="freeLogo" src="<%= request.getContextPath() %>/resources/images/freeboard.png"></a>
	</div> 
...
<thead>
      <tr style="border-bottom:1px solid #c9c9c9;">
        ...
        <input type="password" name="qnaboard_pwd"></td>        
      ...
      <tr>
      	...
      	<input type="text" name="qnaboard_title"></td>
      </tr>
      <tr>
      	<td style="text-align: left;">&nbsp;&nbsp;&nbsp;내용</td>
      	
        	<td>
      		<textarea rows="8" cols="65" name="qnaboard_cont"></textarea>
      	</td>
      </tr>
     </thead>
		</table>
