...
<article>
	...
	<div class="jfbg">
		...
		<form style="height: 580px;" action="updateInfo" method="post"
			id="updateForm" class="form-horizontal">
				...
				<c:choose>
					<c:when test="${loginUser.mem_sex == 1 }">
						<input type="radio" id="mem_sex" name="mem_sex" value="1"
							checked="checked" disabled="disabled">남성
							<input type="radio" id="mem_sex" name="mem_sex" value="2"
							disabled="disabled">여성<br />
					</c:when>
					<c:otherwise>
						<input type="radio" id="mem_sex" name="mem_sex" value="1"
							disabled="disabled">남성
							<input type="radio" id="mem_sex" name="mem_sex" value="2"
							checked="checked" disabled="disabled">여성<br />
					</c:otherwise>
				</c:choose>

				<label id="sexCheck" class="cex"></label><br /> 
				<label class="control-label col-sm-2" for="addr_zipnum">주소</label> 
				<input class="form-control" type="text" id="addr_zipnum"
					name="addr_zipnum" value="${loginUser.addr_zipnum }"> 
				<input class="form-control" type="text" id="mem_addr" name="mem_addr"
					value="${loginUser.mem_addr }"> 
				<label class="control-label col-sm-2" for="mem_addr_detail">상세주소</label> 
				<input class="form-control" type="text" id="mem_addr_detail" name="mem_addr_detail"
					value="${loginUser.mem_addr_detail }"> 
				<input style="margin-left: 25.5%; background-color: #3EAF0E; font-size: 13pt;"
					type="button" value="주소 찾기" class="btn btn-success"
					onclick="post_zip()"><br>
				<br> <label class="cec" for="addr_zipnum" id="addrCheck"></label>
				<br /> <input id="idsubmit" type="button"
					style="margin-left: 23%; background-color: #3EAF0E; font-size: 18pt; color: white;"
					class="btn" onclick="go_update();" value="수정완료">
