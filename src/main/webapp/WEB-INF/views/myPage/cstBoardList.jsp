				...
				<c:otherwise>
					<c:forEach items="${cstBoardList}" var="cstBoardVO">
						<tr>
							...
							<td><a
								href="<%=request.getContextPath()%>/mypage/CstBoardDetail?cstboard_counsel_posting_no=${cstBoardVO.cstboard_counsel_posting_no}">${cstBoardVO.cstboard_counsel_title}</a></td>
