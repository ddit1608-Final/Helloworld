...
<article>
	...
	<form id="cstWriteForm" name="cstWriteForm" method="post"
		...
		<input id="mem_mail" name="mem_mail" hidden="hidden" value="${loginUser.mem_mail}">
		<input id="flow_code" name="flow_code" hidden="hidden" value="1">
		...
		<div id="divdiv">
			<input class="btn" type="submit" value="글쓰기"><input class="btn"
