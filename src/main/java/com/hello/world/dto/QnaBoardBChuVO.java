...
public class QnaBoardBChuVO {
	
	private String qnaboard_board_chu;
	private String qnaboard_board_bchu;
	...
	public String getQnaboard_board_bchu() {
		return qnaboard_board_bchu;
	}
	public void setQnaboard_board_bchu(String qnaboard_board_bchu) {
		this.qnaboard_board_bchu = qnaboard_board_bchu;
	}
